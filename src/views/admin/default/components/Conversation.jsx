...
const DailyTraffic = () => {
  ...
  return (
    <Card extra="pb-7 p-[20px]">
      ...
      <div className="h-[200px] w-full pt-5 pb-0">
        {ChatData.map((data) => (
          <div className="flex flex-row justify-between items-center mb-3 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer">
            ...
            <Chip color="gray" size="xs" value="2" variant="ghost" className="rounded-full text-[12px] font-bold leading-4 text-gray-800 dark:text-white mr-5">
            </Chip>
